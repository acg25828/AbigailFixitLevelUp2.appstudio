...
const cacheName = 'AbigailFixitLevelUp2-2020-10-29 13:09:59.703204'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'AbigailFixitLevelUp2'.length) === 'AbigailFixitLevelUp2') {
